...
export default function TermsInfo() {
  return (
    <div className="grid mt-16 lg:px-16 px-8 gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-4 items-center justify-items-center bg-slate-100">
        <div className='flex flex-col justify-center gap-3 items-center h-72 p-4 w-full '>
